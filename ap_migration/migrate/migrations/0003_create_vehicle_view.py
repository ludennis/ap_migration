...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        query = """
            CREATE VIEW vehicle_view
            AS
            SELECT ID, import_trainee.firstName, import_trainee.lastName, 
            trainee.vehicleInfoOld, trainee.vehicleLicense, trainee.vehicleColor,
            import_trainee.state, import_trainee.vehicleInfo 
            FROM trainee, import_trainee 
            WHERE trainee.id = import_trainee.traineeid;
        """
        db.execute(query)
